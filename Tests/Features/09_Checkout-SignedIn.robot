...
#    Close the Get the First Look modal
   ...
   IF   '${shopLocale}' in ['US']
    ...
    Enter valid Shipping details    ${Eps_login_email}    ${FIRST_NAME_EDITED}   ${LAST_NAME_EDITED}   ${NewUser_StreetAddress_EDITED}  ${NewUser_Flat_EDITED}  ${NewUser_City_EDITED}  ${NewUser_State_EDITED}  ${NewUser_Zipcode_EDITED}  ${NewUser_Phone_EDITED}
...
#    Check Email in Account Page     ${Eps_login_email}
...
07-Signed User/Physical Gift Card/Paypal
    [Tags]  checkout  siafr
    Skip If   '${shopLocale}' in ['UK','FR','GR','IT']
